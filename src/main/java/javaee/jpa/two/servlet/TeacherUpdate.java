...
@WebServlet(name = "TeacherUpdate", value = "/jpa/teacher/update")
public class TeacherUpdate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Teacher teacher=new Teacher(id,Integer.parseInt(req.getParameter("age")),req.getParameter("gender"),req.getParameter("name"),new Course(1,req.getParameter("course")));
