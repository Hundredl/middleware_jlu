...
@MessageDriven(activationConfig =  {
        ...
        @ActivationConfigProperty(propertyName = "clientID", propertyValue = "consumer2")
})
public class PubSubMDB2 implements MessageListener {
    ...
    public void onMessage(Message inMessage) {
        ...
        try {
            if (inMessage instanceof TextMessage) {
                ...
                System.out.println("PubSub消息驱动Bean 2 接收到的消息:" + msg.getText());
            }
            else {
